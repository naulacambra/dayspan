...
export class Pattern {
   ...
   * @see [[Pattern.isMatch]]
   */
  public static findMatch<M, I extends ScheduleInput<M> | Schedule<M>>(
    input: I,
    listedOnly = true,
    exactlyWith?: Day
  ): Pattern {
  ...
  public applyGeneric(
    ...
    removeFrequency: (property: DayProperty) => any
  ): void {
  ...
  public isMatchGeneric(getFrequency: (property: DayProperty) => FrequencyValue, exactlyWith?: Day): boolean {
    ...
    for (const prop of Pattern.PROPS) {
      ...
      if (fn.isObject(rule)) {
        ...
        const currOffset = (curr as FrequencyValueEvery).offset || 0
...
export let Patterns: Pattern[] = [
  new Pattern('none', true, (day: Day) => 'Does not repeat', {
    year: 1,
    month: 1,
    dayOfMonth: 1,
  }),
  new Pattern('daily', true, (day: Day) => 'Daily', {}),
  new Pattern('weekly', true, (day: Day) => 'Weekly on ' + day.format('dddd'), {
    dayOfWeek: 1,
  }),
  new Pattern(
    'monthlyWeek',
  ...
  new Pattern('annually', true, (day: Day) => 'Annually on ' + day.format('MMMM Do'), {
    month: 1,
    dayOfMonth: 1,
  }),
  new Pattern(
    ...
    (day: Day) =>
      'Annually on the ' +
      Suffix.CACHE[day.weekspanOfMonth + 1] +
      ' ' +
      day.format('dddd') +
      ' of ' +
      day.format('MMMM'),
  ...
  new Pattern('weekday', true, (day: Day) => 'Every weekday (Monday to Friday)', {
    dayOfWeek: [Weekday.MONDAY, Weekday.TUESDAY, Weekday.WEDNESDAY, Weekday.THURSDAY, Weekday.FRIDAY],
  }),
  new Pattern('monthly', true, (day: Day) => 'Monthly on the ' + day.format('Do') + ' day', {
    dayOfMonth: 1,
  }),
  new Pattern('custom', true, (day: Day) => 'Custom...', {
    dayOfWeek: false,
    dayOfMonth: false,
